    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Container(height: 80, width: 100, color: Colors.deepPurple, child: NewButton(voidcallback: () {}, buttonheight: 15, buttonwidth: 30, usingIcon: false,text: 'Approve', circle: true, textsize: 20 ))
